...
public class ProjectServiceImpl implements ProjectService {
	...
	@Override
	public List<createrProject> getAllProjectNameByStatus(String status) {
		// TODO Auto-generated method stub
		return null;
	}
...
//	public List<createrProject> getAllProjectNameByStatus(String status) {
//		// TODO Auto-generated method stub
//		List<createrProject>  createrProjects;
//		for (int i = 0; i < createrProjects.size(); i++) {
//			if(createrProjects.get(i).getStatus().equals(status)) {
//				createrProjects.get(i).getProjectInfo();
//			}
//		}
//		return  ;
//	}
